...
function f4() {
    document.querySelector('.out-4').innerHTML = ar4[0] + ' ' + ar4[2] + ' ' + ar4[7]
}
...
function f5() {
    ...
    document.querySelector('.out-5').innerHTML ='sum: ' + sum
}
...
out10 = ''
function f10() {
    sum = sum + ar10[0] + ar10[ar10.length-1]
    out10 = sum
...
function f16() {
    ...
    document.querySelector('.out-16').innerHTML = out15
