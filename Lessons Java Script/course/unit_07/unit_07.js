...
// Функція являє собою конструкцію, яка при першому проході файла JS пропускає функцію до тих, поки функція не буде викликана

// Функція може бути викликана
one()
f1.onclick = one // без круглих скобок

//Функция делает определенние действия и возвращает значения
