...
function f4() {
    ...
    myCheckbox4 = (document.querySelector('.i-4'))
...
function f5() {
    ...
    myCheckbox5 = (document.querySelector('.i-5'))
...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = input6
}
...
function f8() {
    out8.innerHTML = '<input type="text" class="i-81"><button class="b-81">Ok</button>'
...
function f11() {
    ...
    let input2 = document.querySelector('.i-112').value
    input1.style.color = input2
...
function f14() {
    let input = document.querySelector('.t-14').value
...
function f15() {
    let text = document.querySelector('.t-15').value
    let input = document.querySelector('.i-15').value
    let out =  document.querySelector('.out-15')
    out.innerHTML = text + input 
...
function f18() {
    ...
    document.querySelector('.i-18').innerHTML = select
