...
//Для запуска функции через определенное количество времени существует конструкция setTimeout
// const timerID = setTimeout(function() {
//     console.log('Hello')
// }, 2000);

//+ дана конструкція може приймати аргументи, які будуть аргументами для функції всередині (використовується не часто)
